/*
    ...
    SPDX-FileCopyrightText: 2022 Yura Beznos <yura.beznos@you-ra.info>
...
bool KDjVu::openFile(const QString &fileName)
{
    ...
    case DDJVU_DOCTYPE_UNKNOWN:
        doctype = "Type of DjVu document", "Unknown";
        break;
    case DDJVU_DOCTYPE_SINGLEPAGE:
        doctype = "Type of DjVu document", "Single Page";
        break;
    case DDJVU_DOCTYPE_BUNDLED:
        doctype = "Type of DjVu document", "Bundled";
        break;
    case DDJVU_DOCTYPE_INDIRECT:
        doctype = "Type of DjVu document", "Indirect";
        break;
    case DDJVU_DOCTYPE_OLD_BUNDLED:
        doctype = "Type of DjVu document", "Bundled (old)";
        break;
    case DDJVU_DOCTYPE_OLD_INDEXED:
        doctype = "Type of DjVu document", "Indexed (old)";
        break;
    }
    if (!doctype.isEmpty())
