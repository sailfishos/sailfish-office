        ...
        Column {
            ...
            InfoLabel {
                text: doc.failure ? //% "Broken file"
                                    qsTrId("sailfish-office-me-broken-djvu")
                                  : //% "Locked file"
                                    qsTrId("sailfish-office-me-locked-djvu")
            }
            ...
            InfoLabel {
                ...
                text: doc.failure ? //% "Cannot read the DJVU document"
                                    qsTrId("sailfish-office-me-broken-djvu-hint")
                                  : //% "Enter password to unlock"
                                    qsTrId("sailfish-office-me-locked-djvu-hint")
            }
/*
            Item {
